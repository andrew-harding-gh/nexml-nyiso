...
RAW_HOURLY_FC = [
    {'wind_cdir': 'NE', 'rh': 79, 'pod': 'd', 'timestamp_utc': '2020-05-18T17:00:00', 'pres': 1020.51,
     ...
     'dhi': 123.25, 'app_temp': 14.2, 'dt_for': '2020-05-18:17', 'temp': 14.2, 'ghi': 977.62,
    ...
    {'wind_cdir': 'NE', 'rh': 79, 'pod': 'd', 'timestamp_utc': '2020-05-18T18:00:00', 'pres': 1020,
     ...
     'dhi': 121.42, 'app_temp': 14.7, 'dt_for': '2020-05-18:18', 'temp': 14.7, 'ghi': 940.3,
    ...
    {'wind_cdir': 'NE', 'rh': 80, 'pod': 'd', 'timestamp_utc': '2020-05-18T19:00:00', 'pres': 1019.82,
     ...
     'dhi': 116.61, 'app_temp': 14.8, 'dt_for': '2020-05-18:19', 'temp': 14.8, 'ghi': 847.09,
     'clouds_mid': 3, 'clouds_low': 3}
]

CLEAN_HOURLY_FC = [
    WbClient.hourly_forecast(station_abbr='KLGA', dt_fetched=datetime.datetime(2020, 5, 18, 12, 0),
                             dt_for=datetime.datetime(2020, 5, 18, 13, 0), temp=14.2, app_temp=14.2, dwpt=10.5, rh=79,
                             wspd=4.55958, wdir=38, wc=7.0, clds='OVC', vis=24.1, pres=1020.51, uv_idx=8.87044, prcp=0,
                             heat_idx=9.0),
    WbClient.hourly_forecast(station_abbr='KLGA', dt_fetched=datetime.datetime(2020, 5, 18, 12, 0),
                             dt_for=datetime.datetime(2020, 5, 18, 14, 0), temp=14.7,
                             app_temp=14.7, dwpt=11, rh=79, wspd=4.63194, wdir=40, wc=7.0,
                             clds='OVC', vis=24.1, pres=1020, uv_idx=2.85233, prcp=0,
                             heat_idx=10.0),
    WbClient.hourly_forecast(station_abbr='KLGA', dt_fetched=datetime.datetime(2020, 5, 18, 12, 0),
                             dt_for=datetime.datetime(2020, 5, 18, 15, 0), temp=14.8, app_temp=14.8, dwpt=11.3, rh=80,
